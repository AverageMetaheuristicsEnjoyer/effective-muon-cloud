...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"llama257m_tucker_r259_tensorion_riemannian_muon_paper_mup_functional_no_postns_tangent_adamw_ns6_vector_transport_densehead_retract_1x_chinchilla_wd01_bestval_trainbs32_acc4_evalbs32"}
