...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"llama257m_tucker_late_169m_to_257m_customfb_bs16acc8"}
export TARGET_PARAMETER_COUNT=169193488
export TARGET_PARAMETER_TOLERANCE=0
export TUCKER_RANKS=""
export TUCKER_ATTENTION_RANKS="29,30,30,30"
export TUCKER_GATE_UP_RANKS="29,30,25,36"
export TUCKER_DOWN_RANKS="25,36,29,30"
export TUCKER_PROGRESSIVE_STAGES=${TUCKER_PROGRESSIVE_STAGES:-"0:169193488 32325:191314204 33325:213434920 34325:235555636 35325:257676352"}
