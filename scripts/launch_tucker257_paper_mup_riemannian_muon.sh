...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"llama257m_tucker_r259_tensorion_riemannian_muon_paper_mup_structureaware_adamw_ns6_vector_transport_densehead_retract_1x_chinchilla_wd01_bestval_trainbs4_acc32_evalbs4"}
...
export TUCKER_LR_SCALING_MODE=paper_mup
export TUCKER_LR_SCALING_LOG_INTERVAL=${TUCKER_LR_SCALING_LOG_INTERVAL:-10}
export WEIGHT_DECAY=0.1
export WEIGHT_DECAY_TAG=wd01
export SAVE_BEST_VAL_CHECKPOINT=1
export LATEST_CKPT_INTERVAL=0
export BATCH_SIZE=${BATCH_SIZE:-4}
export ACC_STEPS=${ACC_STEPS:-32}
