...
export PIP_USER=1
PYTHON_XY="$(python -c 'import sys; print(f"{sys.version_info.major}.{sys.version_info.minor}")')"
export LD_LIBRARY_PATH="${CONDA_PREFIX:-/home/user/conda}/lib/python${PYTHON_XY}/site-packages/nvidia/cusparselt/lib:$PYTHONUSERBASE/lib/python${PYTHON_XY}/site-packages/nvidia/cusparselt/lib:${LD_LIBRARY_PATH:-}"
